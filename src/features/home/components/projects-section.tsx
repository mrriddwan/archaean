            ...
            >
              {project.href ? (
                <a
                  ...
                  className="block rounded border border-slate-600/60 bg-zinc-800/80 p-5 transition-colors hover:border-slate-500 hover:bg-zinc-800 sm:p-6"
                >
                ...
                <div className="block rounded border border-slate-600/60 bg-zinc-800/80 p-5 sm:p-6">
                  <p className="font-medium text-slate-200 text-base sm:text-lg">{project.name}</p>
                  <p className="mt-1 text-sm text-slate-500 sm:text-base">{project.period}</p>
                  <p className="mt-2 text-sm leading-relaxed text-slate-300 sm:text-base">
                    {project.description}
