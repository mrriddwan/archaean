...
export function AboutSection() {
  return (
    <section className="relative border-b border-slate-700/50 bg-zinc-900 px-4 py-20 sm:px-6 sm:py-28 md:px-8 md:py-32">
      <div className="mx-auto max-w-3xl relative z-20">
        ...
        >
          <HyperText className="text-base leading-relaxed text-slate-300 sm:text-lg md:text-xl">{ABOUT}</HyperText>
        </motion.p>
      </div>
    </section>
  )
